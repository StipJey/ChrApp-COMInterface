        ...
        self.printBundle = function(aFirstValue, aSecondValue, aFont){
            ...
            switch (aFont){
                case 0: case 16: case 128: case 144:
                    if (aFirstValue.length + aSecondValue.length > 32){
                        newLine = 1; break;
                    }
                    spaces = 32 - (aFirstValue.length + aSecondValue.length);
                    break;
                case 32: case 48: case 160: case 176:
                    if (aFirstValue.length + aSecondValue.length > 16){
                        newLine = 1; break;
                    }
                    spaces = 16 - (aFirstValue.length + aSecondValue.length);
                    break;
                case 1: case 17:
                    if (aFirstValue.length + aSecondValue.length > 40){
                        newLine = 1; break;
                    }
                    spaces = 40 - (aFirstValue.length + aSecondValue.length);
                    break;
                case 33: case 49:
                    if (aFirstValue.length + aSecondValue.length > 18){
                        newLine = 1; break;
                    }
                    spaces = 18 - (aFirstValue.length + aSecondValue.length);
                    break;
                default :
                    newLine = 0;
                    spaces = 0;
